            ...
            Rectangle {
                ...
                SwipeView {
                    ...
                    Item {
                        ...
                        Text {
                            id: link_Text
                            text: '<html><style type="text/css"></style><a href="http://google.com">1. google</a></html>'
                        ...
                        Text {
                            ...
                            x: 0
                            y: 25
                            text: '<html><style type="text/css"></style><a href="http://facebook.com">2. Python in Qt</a></html>'
                            onLinkActivated: Qt.openUrlExternally("https://www.google.fr/search?q=python+in+qt&oq=python+in+qt&aqs=chrome..69i57j0l5.15619j0j7&sourceid=chrome&ie=UTF-8&pli=1")
                            wrapMode: TextEdit.WordWrap
                            font.family: "Courier"
                            font.pointSize: 12
                            visible: (swipeView.currentIndex == 0) ? true : false
